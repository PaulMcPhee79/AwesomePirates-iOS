...
GFX_PATH_1X="../Graphics/@2x/Atlases"
...
then
	...
	rm -f ${RES_PATH_IMAGES_1X}/railings/*.png
	...
	rm -f ${RES_PATH_IMAGES_2X}/railings/*.png
	...
	cp ../Graphics/@2x/Images/railings/*.png ${RES_PATH_IMAGES_1X}/railings/
	...
	#mogrify -scale 50% ${RES_PATH_IMAGES_1X}/railings/*.png
	...
	for i in ${RES_PATH_IMAGES_1X}/railings/*@2x.png
	do
		NEW_PATH=${i/%@2x.png/.png}
		mv $i $NEW_PATH
	done
	...
	cp ../Graphics/@2x/Images/railings/*.png ${RES_PATH_IMAGES_2X}/railings/
