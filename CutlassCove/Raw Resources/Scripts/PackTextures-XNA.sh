...
# At terminal: xattr -d com.apple.quarantine ./PackTextures-XNA.sh
...
then
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/achievements-atlas.png \
			--algorithm MaxRects \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/achievements-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/fancy-text-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/fancy-text-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/gameover-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/gameover-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/help-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/help-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/lite-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/lite-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/objectives-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/objectives-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/playfield-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 1 \
	...
	${TP}	--smart-update \
			...
			--data ${OUT_PATH_2X}/playfield-atlas.xml \
			--sheet ${OUT_PATH_2X}/playfield-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 1 \
			--disable-rotation \
	...
	do
		...
		${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/railings/$RAILING-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 0 \
	...
	do
		...
		${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/railings/$RAILING-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 0 \
			--disable-rotation \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_1X}/waves$i-atlas.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--scale 0.5 \
			--shape-padding 0 \
	...
	${TP}	--smart-update \
			...
			--sheet ${OUT_PATH_2X}/waves$i-atlas@2x.png \
			--algorithm MaxRects \
			--maxrects-heuristics best \
			--shape-padding 0 \
			--disable-rotation \
